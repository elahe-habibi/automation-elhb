...
describe("Create-Doc", () => {
  ...
  it('cancel-document', () => {
    ...
    cy.get('[data-cy="CreatDoc-Cancel"]').click();
    cy.wait(3000); // Waits for 3 seconds
    cy.get('[data-cy="CreatDoc-Cancel1"]').click();
    cy.wait(3000); // Waits for 3 seconds
    cy.get('[data-cy="CreatDoc-Cancel2"]').click();
    cy.wait(3000); // Waits for 3 seconds
    cy.get('[data-cy="CreatDoc-Cancel-close"]').click();

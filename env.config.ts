...
export const ENV_CONFIG = {
  ...
  SSO_URL: process.env.SSO_URL || 'https://sso-sandbox.sandpod.ir/oauth2/authorize/index.html',
  ...
  // Repository URLs
  REPOSITORY_MANAGEMENT: process.env.REPOSITORY_MANAGEMENT || '/admin/dashboard',
  MY_REPOSITORIES: process.env.MY_REPOSITORIES || '/admin/dashboard',
  CREATE_REPOSITORY: process.env.CREATE_REPOSITORY || '/admin/repository/create',

  // SSO Parameters
  SSO_PARAMS: {
    client_id: process.env.SSO_CLIENT_ID || '18682629g64434d74b0004e8ecb3d3be1',
    response_type: process.env.SSO_RESPONSE_TYPE || 'code',
    redirect_uri: process.env.SSO_REDIRECT_URI || 'https://clasor-frontend.sandpod.ir/signin',

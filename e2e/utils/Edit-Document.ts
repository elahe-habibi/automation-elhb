...
export class EditDocument {
    ...
    async editDocument() {
        ...
        // فیلد توضیحات سند
        const descriptionInput = this.page.locator('.document-edit__form-description');
        ...
        const edittButton = this.page.locator('.dialog-footer__submit-button');
        // بررسی اینکه دکمه قابل مشاهده است
        await expect(edittButton).toBeVisible();
        // کلیک روی دکمه "ویرایش"
        await edittButton.click();

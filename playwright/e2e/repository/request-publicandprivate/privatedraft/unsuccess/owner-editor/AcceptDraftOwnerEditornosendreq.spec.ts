...
import { RepositoryUtils } from '../../../../../utils/user/create/CreateGroup-Adminuser';
...
import { AcceptDraft } from '../../../../../utils/repository/requests/privatedraft/AcceptDraftOwner-Editornosendreq';
import path from 'path';

test.describe('Repository Create and Share', () => {
  let authUtils: AuthUtils;
  let repoUtils: RepositoryUtils;
  let DocumentUtils: AcceptDraft;
  ...
  test.beforeEach(async ({ page }) => {
    ...
    DocumentUtils = new AcceptDraft(page);
  ...
  test('should create a repository with custom image upload', async ({
    ...
    await DocumentUtils.acceptDraft();
    ...
    // await DocumentUtils.acceptVersionDraftRequest();
  });
});

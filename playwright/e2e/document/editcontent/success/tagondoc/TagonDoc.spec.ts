...
import { TagDocument } from '../../../../utils/document/tag/TagonDocument';
...
test.describe('Repository Create and Share', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    DocumentTag = new TagDocument(page);
  ...
  test('Create New Document', async ({ page }) => {
    ...
    // افزودن یک تگ
    await DocumentTag.addTag('tagName');

    // افزودن چندین تگ
    await DocumentTag.addMultipleTags(['تگ1', 'تگ2', 'تگ3']);

    await DocumentUtils.tagondoc();

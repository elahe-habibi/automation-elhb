...
import { EditDocument } from '../../../../utils/document/edit/EditDocument';
import { DocumentManager } from '../../../../utils/document/create/CreateDocument';
import { BookMarkDocument } from '../../../../utils/document/BookMarkDocument';
import { EditRepositoryBookMark } from '../../../../utils/repository/bookmark/BookmarkRepoWriter';
...
test.describe('Repository Create and Share', () => {
  ...
  test('Create New Document', async ({ page }) => {
    ...
    await expect(toastMessage).toContainText('سند مورد نظر به نشان شده ها اضافه شد.', { timeout: 5000 });
  });
});

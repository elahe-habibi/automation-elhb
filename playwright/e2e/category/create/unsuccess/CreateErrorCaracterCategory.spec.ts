...
import { CategoryManager } from '../../../utils/category/create/CreateErrorcarCategory';
...
test.describe('Repository Create and Share', () => {
  ...
  test('Create Category', async ({ page }) => {
    ...
    // ✅ تست با موفقیت خطا را تأیید کرد — نیاز به بررسی توست نیست
  console.log('🎉 تست کاراکترهای غیرمجاز با موفقیت انجام شد!');
  });
});

...
import { CopyAddressShareVer } from '../../../../utils/version/CopyAddressShareVer';
import { DocumentManager } from '../../../../utils/document/create/CreateDocument';

test.describe('Repository Create and Share', () => {
  let authUtils: AuthUtils;
  let repoUtils: RepositoryUtils;
  let DocumentUtils: CopyAddressShareVer;

  test.beforeEach(async ({ page, browser }) => {
    // ایجاد نمونه‌های کلاس‌های کمکی
    authUtils = new AuthUtils(page);
    repoUtils = new RepositoryUtils(page);
    DocumentUtils = new CopyAddressShareVer(page, browser);

...
import { EditVersion } from '../../../../../utils/document/delete/DeleteDraft';
import { DocumentManager } from '../../../../../utils/document/create/CreateDocument';
import { EditRepositoryBookMark } from '../../../../../utils/repository/bookmark/BookmarkRepoAdmin';

test.describe('Repository Create and Share', () => {
  let authUtils: AuthUtils;
  let repoUtils: RepositoryUtils;
  let DocumentUtils: EditVersion;
  ...
  test.beforeEach(async ({ page }) => {
    ...
    DocumentUtils = new EditVersion(page);

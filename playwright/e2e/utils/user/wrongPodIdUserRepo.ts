...
async shareRepository(username: string) {
  ...
  try {
    ...
    expect(toastMessage).toContain('نام کاربری پیدا نشد - cl-32');
  ...
  // ✅ کلیک ۴ باره روی دکمه ادامه (طبق درخواست)
  console.log('🖱️ شروع به کلیک ۴ باره روی دکمه "ادامه"...');
  ...
  console.log('✅ ۴ بار کلیک روی دکمه "ادامه" با موفقیت انجام شد');
}

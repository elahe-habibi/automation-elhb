...
// ═════════════════════════════════════════════════════════
// ✅ پیدا کردن و کلیک روی دکمه "انصراف" در دیالوگ (بر اساس ساختار دقیق HTML شما)
// ═════════════════════════════════════════════════════════
console.log('⏳ در حال پیدا کردن دکمه "انصراف" در دیالوگ...');

// سلکتور هوشمند با دو لایه پشتیبان (بر اساس کلاس + متن دقیق):
const cancelButton = this.page.locator(
  // روش اصلی: کلاس اختصاصی cancel-button + متن فارسی
  'div.dialog-footer button.cancel-button:has(p:text("انصراف")), ' +
  
  // روش پشتیبان: جستجوی مستقیم متن "انصراف" در دکمه‌های فوتر دیالوگ
  'div.dialog-footer button:has-text("انصراف")'
).first();
...
// کلیک ایمن
await cancelButton.click();
console.log('✅ دکمه "انصراف" با موفقیت کلیک شد و دیالوگ بسته شد');

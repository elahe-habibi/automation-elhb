...
export class EditRepository {
  ...
  // اگر نام جدید داده شده، از آن استفاده کن، در غیر این صورت نام فعلی را بخوان
  const nameToUse = newName !== undefined ? newName : await nameInput.inputValue();
  
  console.log('نام جدید برای مخزن:', nameToUse);
  ...
  console.log('نام مخزن ویرایش شد به:', nameToUse);
  }

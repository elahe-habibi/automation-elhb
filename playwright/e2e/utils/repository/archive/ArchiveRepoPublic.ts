...
// ═════════════════════════════════════════════════════════
// ✅ پیدا کردن و کلیک روی دکمه بستن (X) با استفاده از کلاس منحصر به فرد
// ═════════════════════════════════════════════════════════
console.log('🎯 در حال پیدا کردن دکمه بستن (X)...');

// سلکتور دقیق بر اساس کلاس موجود در HTML شما
const closeButton = this.page.locator(
  'button.close-button' // ✅ دقیقاً همان کلاس از کد شما
).first(); // انتخاب اولین دکمه (در صورت وجود چند دیالوگ)

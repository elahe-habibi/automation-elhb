...
export class EditRepositoryShareLink {
  ...
  async AcceptRequestWhitelist(): Promise<void> {
    ...
    // کلیک روی دکمه رد کردن
    console.log('🔴 کلیک روی دکمه رد کردن...');

    const rejectBtn = this.page
      .locator('button.request-menu__reject-button')
      .first();
    ...
    console.log('✅ دکمه رد کردن کلیک شد');
  }

...
export class FilemanageRepository {
  ...
  async manageFiles() {
    ...
    const deleteBtn = this.page
      .locator('li:has(p)', { hasText: 'حذف فایل' })
      .first();
    ...
    const confirmButton = this.page.locator(
      'button.dialog-content__submit.cls-btn.lib-btn.lib-modal-btn-success',
    );
  ...
  async manageFilesCancel() {
    ...
    await this.page.locator('button.lib-modal-btn-cancel').click();
  ...
  async manageFilesPublic() {
    ...
    await this.page
    .locator('ul.cls-menu')
    .getByRole('button', { name: 'عمومی کردن فایل' })
    .click();
  
    await this.page.waitForTimeout(3000);

    await this.page.locator('div.dialog-content__action-part button', { hasText: 'تایید' }).click();
  ...
  async manageFilesPublicCancel() {
    ...
    await this.page
    .locator('div.dialog-content__action-part')
    .locator('button.lib-modal-btn-cancel')
    .click();

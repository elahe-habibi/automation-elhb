...
import { CreateTag } from '../../../../utils/tag/CreateTagEditor';

test.describe('Repository Edit Tests', () => {
  let authUtils: AuthUtils;
  let repoUtils: RepositoryUtils;
  let editRepo: EditRepository;
  let CreateTagg : CreateTag;
  ...
  test('should edit repository', async ({ page }) => {
    ...
    await CreateTagg.shareRepository('emad.mh');
    ...
    await page.waitForTimeout(3000);
    // کلیک روی دکمه منو
    await CreateTagg.clickDropdownButton();
